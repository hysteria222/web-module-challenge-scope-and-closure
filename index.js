...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
    one has a closure and a nest function and one doesn't
  2. Which of the two uses a closure? How can you tell?
  counter one, because it has a nested function and pulls from the outside function to find variables 
...
function finalScore(inning, numberOf){
let  Home  = 0
let Away  = 0
